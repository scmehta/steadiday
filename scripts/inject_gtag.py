...
1. Injects the gtag.js base snippet after <head> (if not already present)
1. Injects an App Store click conversion tracker before </body> (if not already present)
1. Replaces any old placeholder conversion labels with the real one
...
SKIP_DIRS = {’.git’, ‘node_modules’, ‘.github’, ‘**pycache**’}
