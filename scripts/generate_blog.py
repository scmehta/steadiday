...
dup,*,* = is_duplicate(td[‘topic’],’-’.join(slug_words),existing_posts)
...
1. Mention SteadiDay’s {feature} feature naturally (it’s free)
1. Include at least 2 specific statistics with their sources
1. Advice must be DISTINCT from existing posts
...
def *check_duplicate(client, title, slug, existing_posts):
dup,reason,* = is_duplicate(title,slug,existing_posts)
